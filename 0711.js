 ...
 *   FIXED: Worker code string escape (no more Invalid token)
 * =====================================================================
 * 
 * USAGE:
...
async function slowlorisAttack() {
    while (!isStopping) {
        ...
        try {
            ...
            // Perbaikan: gunakan template literal untuk menghindari escape issues
...
`);
    ...
    class AttackEngine {
        ...
        start(targets) {
            ...
            // Write worker file if not exists
