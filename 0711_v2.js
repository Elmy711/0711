 ...
 *   FIXED: global.verbose → config.verbose, proxy usage, port handling, memory leak
 * =====================================================================
 * 
 * USAGE:
...
const logger = {
    _target: '',
    _verbose: false, // akan diisi dari config
...
// ===== Worker code as a separate file =====
...
`);
    ...
    logger._verbose = config.verbose; // set verbose global
    ...
    // ===== Worker Code (FIXED: global.verbose → config.verbose, proxy usage, port handling) =====
    const WORKER_CODE = `
(async () => {
